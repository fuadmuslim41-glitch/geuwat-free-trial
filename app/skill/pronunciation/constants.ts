...
export const TOPIC_ROUTES: Record<string, string> = {
  ...
  stressing: '/skill/pronunciation/locked/stressing',
  intonation: '/skill/pronunciation/locked/intonation',
  'final-sound': '/skill/pronunciation/locked/final-sound',
  'american-t': '/skill/pronunciation/locked/american-t',
  text: '/skill/pronunciation/locked/text',
  'reading-text': '/skill/pronunciation/locked/reading-text',
};
