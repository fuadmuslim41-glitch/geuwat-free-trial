...
// Empty placeholders for removed data
const vowelLaxExamples: SymbolWordExamples = {};
const diphthongExamples: SymbolWordExamples = {};
const consonantVoicelessExamples: SymbolWordExamples = {};
const consonantVoicedExamples: SymbolWordExamples = {};
