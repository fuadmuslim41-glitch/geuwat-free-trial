...
const PhoneticPortal: React.FC = () => {
  ...
  const [isCommonMistakesOpen, setIsCommonMistakesOpen] = useState(false);
  const [isTongueTwisterOpen, setIsTongueTwisterOpen] = useState(false);
  const [isSummaryOpen, setIsSummaryOpen] = useState(false);
  const [isConsonantPortalOpen, setIsConsonantPortalOpen] = useState(false);
  const [isDiphthongPortalOpen, setIsDiphthongPortalOpen] = useState(false);
  const [isVowelSymbolOpen, setIsVowelSymbolOpen] = useState(false);
  ...
  const togglePortal = (portalId: string) => {
    ...
    // Jika diphthong portal diklik, buka modal premium
    if (portalId === 'diphthong') {
      openDiphthongPortal();
      return;
    }
  ...
  const closeCommonMistakes = useCallback(() => {
    setIsCommonMistakesOpen(false);
  }, []);
  ...
  const closeTongueTwister = useCallback(() => {
    setIsTongueTwisterOpen(false);
  }, []);
  ...
  const openConsonantPortal = useCallback(() => {
    setIsConsonantPortalOpen(true);
  }, []);

  const closeConsonantPortal = useCallback(() => {
    setIsConsonantPortalOpen(false);
  }, []);

  const openDiphthongPortal = useCallback(() => {
    setIsDiphthongPortalOpen(true);
  }, []);

  const closeDiphthongPortal = useCallback(() => {
    setIsDiphthongPortalOpen(false);
  }, []);

  const openVowelSymbol = useCallback(() => {
    setIsVowelSymbolOpen(true);
  }, []);

  const closeVowelSymbol = useCallback(() => {
    setIsVowelSymbolOpen(false);
  }, []);
  ...
  useEffect(() => {
    if (!isCommonMistakesOpen) return;
  ...
  }, [isCommonMistakesOpen, closeCommonMistakes]);

  useEffect(() => {
    if (!isTongueTwisterOpen) return;
  ...
  }, [isTongueTwisterOpen, closeTongueTwister]);
  ...
  }, [isSummaryOpen, closeSummary]);

  useEffect(() => {
    if (!isConsonantPortalOpen) return;
  ...
  }, [isConsonantPortalOpen, closeConsonantPortal]);

  useEffect(() => {
    if (!isDiphthongPortalOpen) return;
  ...
  }, [isDiphthongPortalOpen, closeDiphthongPortal]);

  useEffect(() => {
    if (!isVowelSymbolOpen) return;
  ...
  }, [isVowelSymbolOpen, closeVowelSymbol]);
  ...
  const handleSymbolClick = (symbol: PhoneticSymbol) => {
    // Hanya button 'i' yang dibiarkan berfungsi normal
    const allowedSymbols = ['i'];
    ...
    <div className="pronunciation-layout futuristic-portal-container">
      ...
      <main className="futuristic-portal-main">
          ...
          >
            <div className="card-content">
              <div className="card-icon">
                <div className={`icon-circle ${spinningCard === 'vowel' ? 'spinning' : ''}`} data-tour="phonetic-cpu">
        ...
        {isSymbolTableOpen && (
          ...
          >
            <section
              className="symbol-table-modal premium-feature-modal"
              role="dialog"
              aria-modal="true"
            ...
            >
              ...
              <div className="symbol-table-modal-content premium-content">
                <div className="premium-icon">
                  <svg width="80" height="80" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2Z" fill="currentColor" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </div>
                <h3 className="premium-title">Unlock Complete Phonetic Symbol Chart</h3>
                <p className="premium-description">
                  Dapatkan akses penuh ke Interactive Phonetic Symbol Chart dengan fitur audio pronunciation untuk setiap simbol! 
                  Tingkatkan kemampuan pronunciation Anda dengan belajar langsung dari chart lengkap yang mencakup semua vowel, consonant, dan diphthong sounds.
                </p>
                <ul className="premium-features">
                  <li>✓ Akses ke 44+ phonetic symbols</li>
                  <li>✓ Audio pronunciation untuk setiap symbol</li>
                  <li>✓ Play all symbols feature</li>
                  <li>✓ Organized by categories (vowels, consonants, diphthongs)</li>
        ...
        {isCommonMistakesOpen && (
          <div
            className="symbol-table-modal-overlay"
            onClick={closeCommonMistakes}
            role="presentation"
          >
            <section
              className="symbol-table-modal premium-feature-modal"
            ...
            >
              ...
              <div className="symbol-table-modal-content premium-content">
                ...
                <h3 className="premium-title">Unlock Common Mistakes Feature</h3>
                <p className="premium-description">
                  Pelajari kesalahan pronunciation yang paling sering terjadi dengan fitur Minimal Pairs! 
                  Latih kemampuan Anda membedakan suara-suara yang mirip namun berbeda makna dengan latihan interaktif dan audio examples.
                </p>
                <ul className="premium-features">
                  <li>✓ Akses ke minimal pairs examples</li>
          ...
          >
            ...
            >
              ...
              <div className="symbol-table-modal-content premium-content">
                ...
                <h3 className="premium-title">Unlock Tongue Twister Challenge</h3>
                <p className="premium-description">
                  Asah pronunciation skills Anda dengan koleksi tongue twisters yang menantang! 
                  Latih artikulasi, kecepatan bicara, dan akurasi pronunciation dengan latihan yang fun dan efektif untuk meningkatkan fluency Anda.
                </p>
                <ul className="premium-features">
                  <li>✓ Akses ke tongue twisters sesuai kendalamu</li>
                  <li>✓ Audio pronunciation</li>
                  <li>✓ Recording feature untuk practice</li>
                  <li>✓ Kesulitan yang disesuaikan dari kendalamu</li>
                </ul>
                <a 
                  href="https://learningenglishgeuwat-ten.vercel.app/register"
                  className="premium-cta-btn"
          ...
          >
            ...
            >
              ...
              <div className="symbol-table-modal-content premium-content">
                ...
                <h3 className="premium-title">Unlock Complete Phonetic Summary</h3>
                <p className="premium-description">
                  Dapatkan akses ke comprehensive summary dari semua phonetic symbols! 
                  Pelajari dengan mudah melalui organized reference guide yang mencakup semua vowels, consonants, dan diphthongs dengan penjelasan lengkap dan contoh kata.
                </p>
                <ul className="premium-features">
                  <li>✓ Complete reference guide untuk semua symbols</li>
        ...
        {isConsonantPortalOpen && (
          <div
            className="symbol-table-modal-overlay"
            onClick={closeConsonantPortal}
            role="presentation"
          >
            <section
              className="symbol-table-modal premium-feature-modal"
            ...
            >
              ...
              <div className="symbol-table-modal-content premium-content">
                ...
                <h3 className="premium-title">Unlock Consonant Sounds Portal</h3>
                <p className="premium-description">
                  Kuasai semua consonant sounds dalam bahasa Inggris! 
                  Pelajari perbedaan antara voiced dan voiceless consonants, dengan audio examples dan interactive exercises untuk setiap symbol. Perfect your pronunciation dengan guided practice.
                </p>
                <ul className="premium-features">
                  <li>✓ Akses ke 24+ consonant symbols</li>
                  <li>✓ Voiced vs Voiceless comparison</li>
                  <li>✓ Audio pronunciation untuk setiap consonant</li>
                  <li>✓ Interactive exercises dan quizzes</li>
                  <li>✓ Example words</li>
                </ul>
                <a 
                  href="https://learningenglishgeuwat-ten.vercel.app/register"
        ...
        {isDiphthongPortalOpen && (
          <div
            className="symbol-table-modal-overlay"
            onClick={closeDiphthongPortal}
            role="presentation"
          >
            <section
              className="symbol-table-modal premium-feature-modal"
            ...
            >
              ...
              <div className="symbol-table-modal-content premium-content">
                ...
                <h3 className="premium-title">Unlock Diphthong Sounds Portal</h3>
                <p className="premium-description">
                  Master semua diphthong sounds yang kompleks! 
                  Pelajari cara menggabungkan dua vowel sounds menjadi satu smooth transition. Dengan audio examples dan mouth movement guides, Anda akan menguasai pronunciation yang natural dan fluent.
                </p>
                <ul className="premium-features">
                  <li>✓ Akses ke 8+ diphthong symbols</li>
                  <li>✓ Audio pronunciation</li>
                  <li>✓ Practice exercises</li>
                </ul>
                <a 
          ...
          >
            ...
            >
              ...
              <div className="symbol-table-modal-content premium-content">
                ...
                <h3 className="premium-title">Unlock Vowel Sound Details</h3>
                <p className="premium-description">
                  Pelajari setiap vowel sound secara mendalam dengan detailed explanation dan interactive practice! 
                  Dapatkan akses ke pronunciation guides, audio examples, dan exercises yang dirancang khusus untuk membantu Anda menguasai setiap vowel sound dengan sempurna.
                </p>
                <ul className="premium-features">
                  <li>✓ Detailed explanation untuk setiap vowel</li>
                  <li>✓ Audio pronunciation</li>
                  <li>✓ Example words dengan audio playback</li>
                  ...
                  <div className="symbol-group">
                    ...
                    <div className="symbol-grid">
                      {getSymbolsByCategory('vowel', 'lax').map((symbol) => (
                        <button
                          key={symbol.symbol}
                          className={`symbol-btn ${symbol.symbol !== 'i' ? 'symbol-btn-disabled' : ''}`}
                    ...
                    <div className="symbol-grid">
                      {getSymbolsByCategory('vowel', 'tense').map((symbol) => (
                        <button
                          key={symbol.symbol}
                          className={`symbol-btn ${symbol.symbol !== 'i' ? 'symbol-btn-disabled' : ''}`}
                          data-tour={symbol.symbol === 'i' ? 'phonetic-symbol-i' : undefined}
                          onClick={() => handleSymbolClick(symbol)}
                        >
                          {symbol.symbol}
                        </button>
