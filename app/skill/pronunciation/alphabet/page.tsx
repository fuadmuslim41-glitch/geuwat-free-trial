...
const ALPHABET_EVALUATION_PROMPT =
  "Ingin tahu seberapa akurat pronunciation Anda? Dapatkan analisis mendalam dari AI pronunciation coach dengan feedback detail untuk setiap kata yang Anda ucapkan! Upgrade ke Premium untuk unlock fitur AI Accent Evaluation dan tingkatkan pronunciation skills Anda dengan guidance yang personal.";
...
const AlphabetPage: React.FC = () => {
  ...
  return (
    <div className="pronunciation-layout pronunciation-theme pronunciation-theme--alphabet alphabet-container">
      {/* Back Button */}
      <div className="back-button-fixed" data-tour="alphabet-back">
      ...
      <main className="container mx-auto px-3 sm:px-4 py-6 sm:py-8 max-w-6xl relative z-10">
        ...
        {/* Alphabet Grid */}
        <div className="alphabet-grid" data-tour="alphabet-cards">
        ...
        <section
          className={`alphabet-quick-spelling-panel ${isQuickSpellingOpen ? '' : 'collapsed'}`}          data-tour="alphabet-quick-spelling"          aria-labelledby="alphabet-quick-spelling-title"
        >
          <button
            type="button"
