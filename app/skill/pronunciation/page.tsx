...
const Page: React.FC = () => {
  ...
  }, [selectedTopic.id, navigateToTopic]);
  ...
  return (
    <div className="pronunciation-layout">
      ...
      {/* Main Layout Grid */}
      <div className="relative min-h-full flex flex-col pt-4 md:pt-8 pb-32 md:pb-36">
                ...
                <div className="flex items-start gap-2 sm:gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-[11px] sm:text-sm md:text-base text-white/90">
                          {isTopicLocked 
                            ? `${selectedTopic.title} tersedia di versi lengkap. Lihat preview singkat, lalu daftar untuk unlock.`
        ...
        <div className="mt-3 sm:mt-4 md:mt-6 flex justify-center">
            <button
              ...
              className={`relative w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-r ${selectedTopic.color} text-white rounded-lg font-semibold text-xs sm:text-sm transition-all transform hover:scale-105 inline-flex items-center justify-center shadow-[0_0_35px_rgba(255,255,255,0.35)] overflow-hidden ${
                isTopicLocked ? 'ring-2 ring-yellow-300/60' : 'animate-[pulse_1s_ease-in-out_infinite]'
              }`}
           >
              <Cpu className="w-7 h-7 sm:w-8 sm:h-8 text-white/70" data-tour="pronunciation-menu" />
            </button>
        </div>
      </div>
