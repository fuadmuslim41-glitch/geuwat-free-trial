...
const VOCABULARY_EVALUATION_PROMPT =
  "🎯 Fitur Evaluasi AI Premium - Dapatkan feedback detail untuk pronunciation, grammar, dan meaning dari setiap kalimat yang kamu buat! Daftar sekarang untuk unlock fitur evaluasi lengkap.";
