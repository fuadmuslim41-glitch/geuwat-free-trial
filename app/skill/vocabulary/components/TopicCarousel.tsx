...
type Props = {
  ...
  onLockedClick?: (topicId: string, topicTitle: string) => void;
};
        ...
        {items.map((item, index) => {
          ...
          if (item.isLocked) {
            return (
              ...
              >
                <button
                  className="vocab-topic-card vocab-topic-card--carousel vocab-topic-card--locked"
                  ...
                  onClick={(event) => {
                    ...
                    onLockedClick?.(item.id, item.chipLabel);
                  }}
